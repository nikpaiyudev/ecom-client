            ...
            <div className="flex-1 flex flex-col pt-40 pb-20 justify-center items-center gap-10 w-full">
                <div className="w-[350px] flex flex-col gap-10">
                    <div className="flex w-full flex-col gap-3">
                        <h1 className="text-3xl font-medium">Login into Exclusive</h1>
                    ...
                    <form>
                        ...
                        <PrimaryButton className="mt-5 w-full " onClick={() => { }}><>Login</></PrimaryButton>
                        <Button
                            placeholder={'Google'}
                            size="lg"
                            variant="outlined"
                        ...
                        <div className="flex gap-3 w-full justify-center items-center mt-10">
                            ...
                            <Link href="/auth/login"><span className="underline text-black">Sign Up</span></Link>
                        </div>
                    </form>
                </div>
